...
const BigInt p = BigInt::bitsToBigInt(hexToBitset(
    "EE8172AE8996608FB69359B89EB82A69854510E2977A4D63BC97322CE5DC3386EA0A12B343"
    "E9190F23177539845839786BB0C345D165976EF2195EC9B1C379E3"));
const BigInt q = BigInt::bitsToBigInt(hexToBitset(
    "98915E7EC8265EDFCDA31E88F24809DDB064BDC7285DD50D7289F0AC6F49DD2D"));
const BigInt g = BigInt::bitsToBigInt(hexToBitset(
    "9E96031500C8774A869582D4AFDE2127AFAD2538B4B6270A6F7C8837B50D50F206755984A4"
    "9E509304D648BE2AB5AAB18EBE2CD46AC3D8495B142AA6CE23E21C"));
...
std::pair<BigInt, BigInt> signMessage(BigInt q, BigInt r, BigInt P, BigInt x,
                                      BigInt g, std::vector<uint8_t> message) {
