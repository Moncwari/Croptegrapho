...
const int Nb =
    4; // Количество столбцов (32-битных слов) в блоке AES (фиксировано)

// Определение количества слов в ключе и раундов в зависимости от длины ключа
int Nk;
int Nr;

// S-Box для подстановки байтов
